...
def test_list_private_datasets():
    os.environ['PINECONE_DATASETS_EDNPOINT'] = "s3://ram-datasets"
    lst = list_datasets(
    ...
    print(lst)
    del os.environ['PINECONE_DATASETS_EDNPOINT']
...
def test_load_private_dataset():
    ...
    assert deep_list_cmp(ds.documents.columns, ["id", "values", "sparse_values", "metadata"])
    del os.environ['PINECONE_DATASETS_EDNPOINT']
